...
describe("Pharmacy", () => {
  ...
  // Dafalgan
  it("should Dafalgan degrades in Benefit twice as fast as normal drugs", () => {
    expect(
      new Pharmacy([new Drug("Dafalgan", 10, 3)]).updateBenefitValue()
    ).toEqual([new Drug("Dafalgan", 9, 1)]);
  });
});
